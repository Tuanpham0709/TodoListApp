...
public class SwipeToDeleteCallback extends ItemTouchHelper.SimpleCallback {
    ...
    public SwipeToDeleteCallback(TaskAdapter taskAdapter, Context context, TaskList taskList){
        super(0, ItemTouchHelper.LEFT | ItemTouchHelper.RIGHT);
        this.taskAdapter = taskAdapter;
        this.context = context;
        taskListPresenter = new TaskListPresenter(taskList, context);
    }
    ...
    public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
        ...
        Task task = taskAdapter.data.get(position);
        int id = Integer.parseInt(task.getId());
        taskListPresenter.deleteItem(position,id);
